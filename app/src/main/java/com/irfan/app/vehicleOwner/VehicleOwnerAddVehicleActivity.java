package com.irfan.app.vehicleOwner;
...
import com.irfan.app.LoginActivity;
import com.irfan.app.R;
                                    ...
                                    firestore.collection("vehicles").document(vehicleName.getText().toString()).set(vehicle)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                ...
                                                StorageReference spaceRef = uploadRef.child("images/"+vehicleName.getText().toString());
